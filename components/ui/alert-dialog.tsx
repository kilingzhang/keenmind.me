    ...
    <AlertDialogPortal>
        ...
        <AlertDialogPrimitive.Content
            ...
            className={cn(
                ...
                "bg-white border-gray-200 border shadow-lg",
...
const AlertDialogHeader = ({
    ...
    <div
        className={cn(
            "flex flex-col gap-2 sm:gap-3 text-center sm:text-left",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Title
        ref={ref}
        className={cn(
            "text-lg sm:text-xl font-semibold leading-6 text-gray-900",
            "dark:text-gray-100",
            className
        )}
        {...props}
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Description
        ref={ref}
        className={cn(
            "text-sm sm:text-base leading-6 text-gray-600",
            "dark:text-gray-300",
            className
        )}
        {...props}
