// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: f1d2e8a416fac6b9376661619fd4bb88)
// Runtime types generated with workerd@1.20250409.0 2025-04-02 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		KEENMIND_KV: KVNamespace;
		NODE_ENV: string;
		AUTH_URL: string;
		AUTH_SECRET: string;
